    ...
    <div className="m-4 text-center lg:text-left bg-gradient-to-r from-gray-800 to-gray-900 p-4 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-2 gap-4 text-white font-Roboto text-sm mb-4">
            <div className="bg-gray-700 p-3 rounded-md shadow-sm">
                ...
                <strong className="text-electricBlue">{result.inputs.batteryCapacity} kWh</strong>
            </div>
            <div className="bg-gray-700 p-3 rounded-md shadow-sm">
                <p>Charger Power:</p>
            ...
            <div className="bg-gray-700 p-3 rounded-md shadow-sm">
                ...
                <strong className="text-electricBlue">{result.inputs.cost} €/kWh</strong>
            </div>
            <div className="bg-gray-700 p-3 rounded-md shadow-sm">
                <p>Current Charge:</p>
                <strong className="text-electricBlue">{result.inputs.currentCharge} %</strong>
            </div>
        </div>
        ...
        <div className="flex flex-col items-center lg:items-start mt-4">
            <label className="text-white font-Roboto text-sm mb-2">
                Adjust Target Charge: <span className="text-electricBlue">{targetCharge}%</span>
            </label>
            <input
                type="range"
                ...
                style={{
                    background: `linear-gradient(to right, #06b6d4 ${(targetCharge - result.inputs.currentCharge) / (100 - result.inputs.currentCharge) * 100}%, #4b5563 ${(targetCharge - result.inputs.currentCharge) / (100 - result.inputs.currentCharge) * 100}%)`,
                }}
            />
        </div>
