...
function Calculator() {
  ...
  return (
    <div className="flex flex-col ml-10 md:ml-0 mr-10 lg:ml-0 md:mr-10 mt-8 md:mt-0 bg-gradient-to-b from-darkerBlue to-darkBlue rounded-md shadow-xl shadow-lightGreen lg:w-calculatorWidth">
