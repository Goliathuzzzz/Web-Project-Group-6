...
function InfoBox({ station, onBookmark }) {
  ...
  const googleMapsLink = `https://www.google.com/maps?q=${station.coordinates.latitude},${station.coordinates.longitude}`;
  const googleMapsDirections = `https://www.google.com/maps/dir/?api=1&destination=${station.coordinates.latitude},${station.coordinates.longitude}`;
