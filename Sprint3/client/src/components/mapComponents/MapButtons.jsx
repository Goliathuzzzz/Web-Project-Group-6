...
function MapButtons({ onZoomIn, onZoomOut, onReset }) {
    return (
        <div className="absolute bottom-20 right-6 z-10 rounded flex flex-col gap-1">
            <button onClick={onReset} className="pb-2 transform transition-transform duration-200 hover:scale-110 hover:brightness-150">
                <img src={center} alt="Reset" className="w-10 h-10" />
            </button>
