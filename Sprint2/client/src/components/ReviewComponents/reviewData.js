...
export const reviews = [
    ...
    { id: 3, img: reviewer3, name: "James P.", text: "Great app for EV drivers! The map feature is very detailed and shows all the nearby charging stations. I also appreciate the user reviews and ratings for each station. This app has definitely made my EV driving experience better." , stars: 4}
]